...
export default function TradingSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-white">{t('tabTrading')}</h2>
        <p className="text-gray-400 mt-2">{t('tradingSettingsSubtitle')}</p>
      </div>
