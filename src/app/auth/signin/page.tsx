...
export default function SignIn() {
  ...
  const hasFacebookOAuth = process.env.NEXT_PUBLIC_FACEBOOK_ENABLED === "true"
  const hasGitHubOAuth = process.env.NEXT_PUBLIC_GITHUB_ENABLED === "true"
  const hasAnyOAuth = hasGoogleOAuth || hasFacebookOAuth || hasGitHubOAuth
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                id="email"
                type="email"
                placeholder="demo@billetixx.com"
                value={email}
